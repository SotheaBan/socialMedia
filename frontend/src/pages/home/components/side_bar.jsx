    ...
    <div className=''>
         <div className='hidden md:block'>
          ...
          <div className='md:hidden'>
                    ...
                    <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-[#490057] border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-[#490057] dark:bg-[#490057]">
                        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
                            ...
                            <button data-tooltip-target="tooltip-settings" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                                <svg class="w-5 h-5 mb-1 text-white group-hover:text-blue-600 dark:group-hover:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
