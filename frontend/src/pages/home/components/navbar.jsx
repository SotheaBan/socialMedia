...
function nav() {
  return (
        <div>
            <div className='md:grid grid-cols-7 sm:flex-row sm:items-center'>
                <div className='col-span-1 md:bg-[#490057] sm:bg-white sm:flex- p-8'>
                    <div className='w-14  '>
                    ...
                    <div className='grid grid-cols-5 gap-4 items-center text-center '>
                            ...
                            <div className='col-span-1'>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="font-medium text-[#490057] hidden sm:block">
